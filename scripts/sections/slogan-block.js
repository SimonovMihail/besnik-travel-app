...
export function initSearchStepByStep() {
    ...
    const handleInput = () => {
        if (mediaQuery.matches) {
            ...
            if (!searchPanel || !searchBar) return;
            ...
            function createPeopleField() {
                ...
                peopleButtonWrapMobile.setAttribute('data-js-slogan-search-people-wrap-mobile', '');
                ...
                initPeopleDropdownMenu('[data-js-slogan-people-dropdown-menu-mobile]');
            }
        }
    }
...
export function initPeopleDropdownMenu(containerSelector = '[data-js-slogan-people-dropdown-menu]') {
    const peopleDropdownBlocks = document.querySelectorAll(containerSelector);

    peopleDropdownBlocks.forEach(block => {
        if (block.dataset.initialized) return;

        const peopleDropdownButton = block.querySelector('[data-js-slogan-people-dropdown-menu-button]');
        const peopleDropdownArrow = block.querySelector('[data-js-slogan-people-dropdown-menu-arrow]');
